...
(define (key n)
  (map
   (lambda (L)
     (modulo L 27))
  (list
   (modulo (a1 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (b1 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (c1 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (a2 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (b2 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (c2 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (a3 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (b3 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27)
   (modulo (c3 (car (cdr (get-nth-quadruple n))) (car (cdr (cdr (get-nth-quadruple n))))) 27))))
...
(define (extend-key key size)
  (let ((key-length (length key)))
    (let iterator ((size2 size) (result key))
      (if (<= size2 key-length)
          (take result size)
          (iterator (- size2 key-length) (append result (take key key-length)))))))
...
(define (encrypt/decrypt operator)
  (lambda (message key)
      (map
       (lambda (message key)
         (modulo (operator message key) 27)) message (extend-key key (length message)))))
